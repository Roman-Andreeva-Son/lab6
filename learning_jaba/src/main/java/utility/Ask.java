...
public class Ask {
    ...
    public static MusicBand askMusicBand(StandardConsole console, int id) throws AskBreak{
        ...
        try{
            ...
            return new MusicBand(id, name, coordinates, numberOfParticipants, albumsCount, genre, frontMan);

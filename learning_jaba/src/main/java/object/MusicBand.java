...
public class MusicBand implements Validatable, Comparable<MusicBand>{
    ...
    public MusicBand (int id, String name, Coordinates coordinates, long numberOfParticipants, Long albumsCount, MusicGenre genre, Person frontMan){
        this (id, name, coordinates, LocalDate.now(), numberOfParticipants, albumsCount, genre, frontMan);
    }
